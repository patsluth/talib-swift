...
public class TA_HtSine
{
    public class func calculate(startIndex: Int,
                                ...
                                outSine: inout [Double],
                                outLeadSine: inout [Double]) -> TA_ReturnCode
    {
        ...
        let allocationSize = self.allocationSize(startIndex: startIndex,
                                                 endIndex: endIndex)
        outSine = [Double](repeating: Double.nan, count: allocationSize)
        outLeadSine = [Double](repeating: Double.nan, count: allocationSize)
        ...
        while true {
            ...
            if today >= startIndex {
                ...
                outLeadSine[outIdx] = sin((DCPhase + 45.0) * deg2Rad)
                outIdx += 1
            }
            smoothPrice_Idx += 1
    ...
    {
        return TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.HtSine.rawValue] + 63
    }
