...
public class TA_RateOfChangeRatio100
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = (inDouble[inIdx] / tempReal) * 100.0
            } else {
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = (inCandle[inIdx][inCandleInputType] / tempReal) * 100.0
            } else {
                outDouble[outIdx] = 0.0
            }
            outIdx += 1
