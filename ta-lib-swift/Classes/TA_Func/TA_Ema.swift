...
public class TA_Ema
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        return TA_Core.sharedInstance.TA_INT_EMA(startIndex: startIndex,
                                                 endIndex: endIndex,
                                                 inDouble: inDouble,
                                                 optInTimePeriod: optInTimePeriod,
                                                 optInK: 2.0 / Double(optInTimePeriod + 1),
    ...
    public class func lookback(optInTimePeriod: Int) -> Int
    {
        ...
        return ((optInTimePeriod - 1) + TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.Ema.rawValue])
    }
