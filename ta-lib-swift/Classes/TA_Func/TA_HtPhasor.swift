...
public class TA_HtPhasor
{
    public class func calculate(startIndex: Int,
                                ...
                                outInPhase: inout [Double],
                                outQuadrature: inout [Double]) -> TA_ReturnCode
    {
        ...
        let allocationSize = self.allocationSize(startIndex: startIndex,
                                                 endIndex: endIndex)
        outInPhase = [Double](repeating: Double.nan, count: allocationSize)
        outQuadrature = [Double](repeating: Double.nan, count: allocationSize)
    ...
    {
        return TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.HtPhasor.rawValue] + 32
    }
