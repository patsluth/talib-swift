...
public class TA_RateOfChange
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = ((inDouble[inIdx] / tempReal) - 1.0) * 100.0
            } else {
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = ((inCandle[inIdx][inCandleInputType] / tempReal) - 1.0) * 100.0
            } else {
                outDouble[outIdx] = 0.0
            }
            outIdx += 1
