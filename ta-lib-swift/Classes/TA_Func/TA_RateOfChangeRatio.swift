...
public class TA_RateOfChangeRatio
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = inDouble[inIdx] / tempReal
            } else {
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            trailingIdx += 1
            if tempReal != 0.0 {
                outDouble[outIdx] = inCandle[inIdx][inCandleInputType] / tempReal
            } else {
                outDouble[outIdx] = 0.0
            }
            outIdx += 1
