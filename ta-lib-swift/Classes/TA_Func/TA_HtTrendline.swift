...
public class TA_HtTrendline
{
    ...
    {
        return (TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.HtTrendline.rawValue] + 0x3f)
    }
