...
public class TA_Natr
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        if returnCode == TA_ReturnCode.Success {
            ...
            var outIdx = TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.NormalizedAverageTrueRange.rawValue]
            while true {
                if outIdx == 0 {
                    break
                }
            ...
            if -1E-08 >= tempValue || tempValue >= 1E-08 {
                outDouble[0] = (prevATR / tempValue) * 100.0
            } else {
                outDouble[0] = 0.0
            }
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        if returnCode == TA_ReturnCode.Success {
            ...
            outIdx = 1
            var tempValue = inCandle[today][TA_CandleInputType.Close]
            if -1E-08 >= tempValue || tempValue >= 1E-08 {
                outDouble[0] = (prevATR / tempValue) * 100.0
            } else {
                outDouble[0] = 0.0
            ...
            while true {
                ...
                today += 1
                prevATR /= Double(optInTimePeriod)
                tempValue = inCandle[today][TA_CandleInputType.Close]
                if -1E-08 >= tempValue || tempValue >= 1E-08 {
                    outDouble[0] = (prevATR / tempValue) * 100.0
                } else {
                    outDouble[0] = 0.0
    ...
    public class func lookback(optInTimePeriod: Int) -> Int
    {
        ...
        return (optInTimePeriod + TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.NormalizedAverageTrueRange.rawValue])
    }
