...
public class TA_Cmo
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        if startIndex <= endIndex {
            ...
            if TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.Cmo.rawValue] == 0 &&
                ...
                let tempValue3 = tempValue2 - tempValue1
                let tempValue4 = tempValue1 + tempValue2
                if -1E-08 >= tempValue4 || tempValue4 >= 1E-08 {
                    outDouble[outIdx] = 100.0 * (tempValue3 / tempValue4)
                } else {
            ...
            if today > startIndex {
                ...
                if -1E-08 >= tempValue1 || tempValue1 >= 1E-08 {
                    outDouble[outIdx] = 100.0 * ((prevGain - prevLoss) / tempValue1)
                } else {
                    outDouble[outIdx] = 0.0
                }
                outIdx += 1
    ...
    public class func lookback(optInTimePeriod: Int) -> Int
    {
        ...
        var returnValue = optInTimePeriod + TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.Cmo.rawValue]
