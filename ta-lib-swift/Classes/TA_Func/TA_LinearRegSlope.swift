...
public class TA_LinearRegSlope
{
                                ...
                                outDouble: inout [Double]) -> TA_ReturnCode
    {
        ...
        while true {
            ...
            //outDouble[outIdx] = (((Double(optInTimePeriod) * sumXY) - (sumX * sumY)) / divisor)
            outDouble.append((((Double(optInTimePeriod) * sumXY) - (sumX * sumY)) / divisor))
            outIdx += 1
            today += 1
        }
    }
