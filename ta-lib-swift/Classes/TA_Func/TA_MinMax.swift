...
public class TA_MinMax
{
    ...
    public class func calculate(startIndex: Int,
                                ...
                                outMin: inout [Double],
                                outMax: inout [Double]) -> TA_ReturnCode
    {
        ...
        outMin = [Double](repeating: Double.nan, count: allocationSize)
        outMax = [Double](repeating: Double.nan, count: allocationSize)
