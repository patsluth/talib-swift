...
public class TA_HtDcPeriod
{
    ...
    {
        return TA_Core.sharedInstance.globals.unstablePeriod[TA_FunctionUnstableId.HtDcPeriod.rawValue] + 32
    }
